            ...
            child: Column(
              ...
              children: [
                  ...
                  validation: (String? value) {
                    ...
                    if (value == null || value.isEmpty) {
                      ...
                      if (!value.isValidPasswordHasNumber) {
                        _validation.add("Phải chứa 1 kí tự số");
                      }
                      if (!value.isValidPasswordHasCapitalLetter) {
                        _validation.add("Phải chứa 1 chữ in hoa");
                      }
                      if (!value.isValidPasswordHasLowerCaseLetter) {
                        _validation.add("Phải chứa 1 chữ thường");
                      }
                      if (!value.isValidPasswordHasSpecialCharacter) {
                        _validation
                            .add("Phải chứa 1 kí tự đặc biệt [! @ # \$ %]");
                      }
                    }
                    String msg = '';
                ...
                Row(
                  ...
                  children: [
                    const Text("Tôi đã là thành viên, "),
                    InkWell(
                      onTap: () {
